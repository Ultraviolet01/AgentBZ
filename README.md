...
|---|---|---|---|
| **On-chain agent identity using HCS-14** | ✅ **YES** | **Dedicated HCS-14 Identity Topics**:<br>• [`apps/api/src/lib/hcs14.ts#L36-L85`](https://github.com/Ultraviolet01/AgentBZ/blob/main/apps/api/src/lib/hcs14.ts#L36-L85) (`registerAgentIdentityHCS14` creates dedicated permissioned HCS topics for registered agents and publishes metadata).<br>• [`apps/api/src/routes/agents/deploy.ts#L75-L97`](https://github.com/Ultraviolet01/AgentBZ/blob/main/apps/api/src/routes/agents/deploy.ts#L75-L97) (Auto-registers HCS-14 topic upon agent deployment). | • **ThreadSmith HCS-14 Topic**: [`0.0.10396765`](https://hashscan.io/testnet/topic/0.0.10396765)<br>• **ScamSniff HCS-14 Topic**: [`0.0.10396764`](https://hashscan.io/testnet/topic/0.0.10396764)<br>• **LaunchWatch HCS-14 Topic**: [`0.0.10396766`](https://hashscan.io/testnet/topic/0.0.10396766) |
| **Agent discovery via directory** | ✅ **YES** | **Public Directory Manifest / Registry Discovery**:<br>• [`apps/web/src/app/.well-known/ucp/route.ts`](https://github.com/Ultraviolet01/AgentBZ/blob/main/apps/web/src/app/.well-known/ucp/route.ts) (Unauthenticated public manifest exposes active AgentBazaar agents for discovery).<br>• [`apps/web/src/app/api/agents/deployed/route.ts`](https://github.com/Ultraviolet01/AgentBZ/blob/main/apps/web/src/app/api/agents/deployed/route.ts) (Marketplace listing used by public registry and discovery flows). | Public directory endpoint is live at `https://agent-bz-web.vercel.app/.well-known/ucp` and returns discoverable public agents without authentication; this is a directory-style discovery layer rather than full UCP protocol compliance. |
...
| **Verifiable payment audit trails on HCS** | ✅ **YES** | **Immutable HCS Audit Trail**:<br>• [`apps/api/src/lib/hcs.ts#L33-L61`](https://github.com/Ultraviolet01/AgentBZ/blob/main/apps/api/src/lib/hcs.ts#L33-L61) (`logToHCS` records every execution receipt with buyer account, transaction ID, agent ID, and timestamp). | • **Master Audit Topic**: [`0.0.10396393`](https://hashscan.io/testnet/topic/0.0.10396393)<br>• **Consensus Audit Message**: `1788822794.303355104` (Buyer: `0.0.10389860`, Tx: `0.0.7162784@...`) |
